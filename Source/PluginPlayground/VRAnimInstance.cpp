...
void UVRAnimInstance::NativeUpdateAnimation(float DeltaTimeX)
{
	...
	//	/*SpineBase = OwningPawn->GetConvertedTransform(FName("pelvis")).Rotator();
	//	SpineMid = OwningPawn->GetConvertedTransform(FName("spine_02")).Rotator();
	//	SpineTop = OwningPawn->GetConvertedTransform(FName("spine_03")).Rotator();
	//	ShoulderLeft = OwningPawn->GetConvertedTransform(FName("upperarm_l")).Rotator();
	...
	//		//ElbowLeft = OwningPawn->GetConvertedTransform(FName("lowerarm_l")).Rotator();
	//		//WristLeft = OwningPawn->GetConvertedTransform(FName("hand_l")).Rotator();
	//	}
	...
	//	//	ElbowRight = OwningPawn->GetConvertedTransform(FName("lowerarm_r")).Rotator();
	//	//	WristRight = OwningPawn->GetConvertedTransform(FName("hand_r")).Rotator();
	//	//}
	//	
	//}
}
